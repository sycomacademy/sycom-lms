...
const logger = createLoggerWithContext("BlogPostError");
...
export default function BlogPostError({
  ...
  useEffect(() => {
    logger.error("unhandled blog post error", error);
    captureException(error, { digest: error.digest, route: "blog-post" });
  }, [error]);
      ...
      <section className="container mx-auto flex min-h-[60vh] items-center px-4 py-16">
        <div className="mx-auto max-w-2xl text-center">
          ...
          <p className="mx-auto mb-6 max-w-xl text-muted-foreground text-sm sm:text-base">
            Something unexpected happened while opening this post. Try again, or
            head back to the blog index.
          </p>
          {error.digest ? (
