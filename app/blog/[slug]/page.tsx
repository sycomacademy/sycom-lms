              ...
              <div className="max-w-none text-foreground">
                <ReactMarkdown
                  components={{
                    ...
                    h2: ({ children }) => (
                      <h2 className="mt-6 mb-3 font-bold text-2xl text-foreground">
                        {children}
                      </h2>
                    ),
                    h3: ({ children }) => (
                    ...
                    ul: ({ children }) => (
                      <ul className="mb-4 list-disc pl-6 text-foreground">
                        {children}
                      </ul>
                    ),
                    ol: ({ children }) => (
                      <ol className="mb-4 list-decimal pl-6 text-foreground">
                        {children}
                      </ol>
                    ),
