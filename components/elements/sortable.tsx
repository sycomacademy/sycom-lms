/** biome-ignore-all lint/style/noNestedTernary: Sortable component */
/** biome-ignore-all lint/correctness/useHookAtTopLevel: Sortable component */
"use client";
    ...
    Children.forEach(children, (child) => {
      if (
        ...
        result = cloneElement(child as ReactElement<SortableItemProps>, {
          ...
          className: cn(
            (child.props as SortableItemProps).className,
            "z-50 shadow-lg"
          ),
        });
      }
