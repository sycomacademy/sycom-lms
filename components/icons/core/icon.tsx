...
import { Slot, type WithAsChild } from "@/components/icons/core/slot";
import { useIsInView } from "@/packages/hooks/use-is-in-view";
...
function AnimateIcon({
  ...
  useEffect(() => {
    ...
    // biome-ignore lint/complexity/noExcessiveCognitiveComplexity: animation state machine is intentionally centralized.
    async function run() {
    ...
    // biome-ignore lint/complexity/noVoid: intentional fire-and-forget invocation within effect.
    void run();
...
// biome-ignore lint/complexity/noExcessiveCognitiveComplexity: inherited animation override logic is intentionally handled in one place.
