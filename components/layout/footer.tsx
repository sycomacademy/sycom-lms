...
const popularCourses = [
  ...
  { href: "/courses/comptia-pentest", label: "CompTIA Pentest+" },
  { href: "/courses/comptia-security", label: "CompTIA Security+" },
];

const recentPosts = [
  {
    href: "/blog/what-about-cybersecurity-training-programs",
    title: "What About Cybersecurity Training Programs?",
    date: "01 AUGUST, 2024",
  },
  {
    href: "/blog/transitioning-into-cybersecurity",
    title: "Transitioning into Cybersecurity",
    date: "20 AUGUST, 2024",
  },
  {
    href: "/blog/how-to-start-your-cybersecurity-journey",
          ...
          <div className="flex flex-col gap-4">
            ...
            <nav className="flex flex-col gap-3">
              {recentPosts.map((post) => (
                <Link className="group block" href={post.href} key={post.href}>
